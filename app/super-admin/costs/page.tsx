...
export default async function HereCostAnalyticsPage() {
  ...
  return (
    <div className="container mx-auto p-6 space-y-6">
      ...
      <div>
        <h1 className="text-3xl font-bold mb-2">HERE Cost Analytics</h1>
      ...
      {analytics.unavailable && (
        <Card className="border-amber-200 bg-amber-50">
          <CardContent className="flex items-center gap-3 pt-6 text-amber-800">
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        <Card>
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-sm font-medium">Estimated 24h Cost</CardTitle>
            <DollarSign className="h-4 w-4 text-muted-foreground" />
          </CardHeader>
          <CardContent>
            <div className="text-2xl font-bold">{money(analytics.last24h.costCents)}</div>
        ...
        <Card>
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-sm font-medium">Estimated 7d Cost</CardTitle>
            <Clock className="h-4 w-4 text-muted-foreground" />
          </CardHeader>
          <CardContent>
            <div className="text-2xl font-bold">{money(analytics.last7d.costCents)}</div>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">{analytics.last24h.cacheHits}</div>
      ...
      <div className="grid gap-4 md:grid-cols-2">
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">{analytics.last24h.blocked}</div>
